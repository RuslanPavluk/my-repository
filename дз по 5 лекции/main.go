...
func main() {
	...
	//задаем переменную "цена 9 яблок". для этого цену одного яблока умножаем на количество - "9"
	price9apple:=priceApple*9
	//задаем переменную "цена 8 груш". для этого цену одной груши умножаем на количество - "8"
	...
	//задаем переменную "цена 2 яблок". для этого цену одного яблока умножаем на количество - "2"
	price2apple := priceApple * 2
	//задаем переменную "цена 2 груш". для этого цену одного яблока умножаем на количество - "2"
